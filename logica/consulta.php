...
if ($result) { // Check if the query was successful
    if ($result->num_rows > 0) {
        echo "<table class='table table-bordered table-striped'><thead><tr><th>ID</th><th>Nombre</th><th>Apellido</th><th>cedula</th><th>telefono</th><th>correo</th></tr></thead><tbody>";
